/// DockerBarCore
///
/// Core business logic for DockerBar - a macOS menu bar Docker monitoring app.
...
/// Logger for DockerBarCore operations
public let coreLogger = Logger(label: "com.dockerbar.core")

/// DockerBarCore version information
public enum DockerBarCoreVersion {
